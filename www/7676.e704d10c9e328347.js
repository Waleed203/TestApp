  ...
  [7676],
  {
    7676: (j, v, s) => {
      ...
      const C =
        ...
        O = class {
          constructor(e) {
            (0, i.r)(this, e),
              ...
              (this.lastOnEnd = 0),
              (this.blocker = _.G.createBlocker({ disableScroll: !0 })),
              (this.didLoad = !1),
          ...
          sideChanged() {
            (this.isEndSide = (0, h.p)(this.side)), (this.animation = void 0);
          }
          swipeGestureChanged() {
            this.updateState();
          }
          connectedCallback() {
            ...
            return (0, l.c)(function* () {
              typeof customElements < "u" &&
                ...
                void 0 === e.type && (e.type = o.c.get("menuType", "overlay"));
              const t =
                void 0 !== e.contentId
          ...
          componentDidLoad() {
            var e = this;
            return (0, l.c)(function* () {
              (e.didLoad = !0), e.menuChanged(), e.updateState();
            })();
          }
          menuChanged() {
            this.didLoad &&
          ...
          onSplitPaneChanged(e) {
            const { target: t } = e;
            t === this.el.closest("ion-split-pane") &&
              ((this.isPaneVisible = e.detail.isPane(this.el)),
              this.updateState());
          }
          onBackdropClick(e) {
            this._isOpen &&
          ...
          focusLastDescendant() {
            const { el: e } = this,
              t = Array.from(e.querySelectorAll(C)),
            ...
            n &&
              (this.el.contains(n)
                ...
                : (this.focusFirstDescendant(),
                  this.lastFocus === t.activeElement &&
          ...
          loadAnimation() {
            ...
            return (0, l.c)(function* () {
              ...
              const r = (e.animation = yield c.m._createAnimation(e.type, e));
              o.c.getBoolean("animated", !0) || r.duration(0), r.fill("both");
            })();
          }
          startAnimation(e, t) {
            var n = this;
            return (0, l.c)(function* () {
              const r = !e,
                ...
                f = n.animation
                  ...
                  .easing(r ? u : p);
              t ? yield f.play() : f.play({ sync: !0 }),
                "reverse" === f.getDirection() && f.direction("normal");
            })();
          }
          _isActive() {
          ...
          canStart(e) {
            return (
              ...
              (!!this._isOpen ||
                (!c.m._getOpenSync() &&
                  H(window, e.currentX, this.isEndSide, this.maxEdgeStart)))
            );
          }
          onWillStart() {
          ...
          onStart() {
            this.isAnimating && this.animation
              ...
              : (0, h.o)(!1, "isAnimating has to be true");
          }
          onMove(e) {
            if (!this.isAnimating || !this.animation)
              return void (0, h.o)(!1, "isAnimating has to be true");
            const n = A(e.deltaX, this._isOpen, this.isEndSide) / this.width;
          ...
          onEnd(e) {
            ...
            const t = this._isOpen,
              ...
              u = e.velocityX,
              f = m / 2,
              z = u >= 0 && (u > 0.2 || e.deltaX > f),
              W = u <= 0 && (u < -0.2 || e.deltaX < -f),
              g = t ? (n ? z : W) : n ? W : z;
            let B = !t && g;
            t && !g && (B = !0), (this.lastOnEnd = e.currentTime);
            let E = g ? 0.001 : -0.001;
            E +=
              (0, y.g)(
                [0, 0],
                ...
                [0.6, 1],
                [1, 1],
                (0, h.l)(0, p < 0 ? 0.01 : p, 0.9999),
              )[0] || 0;
            const Q = this._isOpen ? !g : g;
            this.animation
              .easing("cubic-bezier(0.4, 0.0, 0.6, 1)")
              .onFinish(() => this.afterAnimation(B), { oneTimeCallback: !0 })
              .progressEnd(Q ? 1 : 0, this._isOpen ? 1 - E : E, 300);
          }
          beforeAnimation(e) {
            (0, h.o)(
              !this.isAnimating,
              ...
              this.backdropEl && this.backdropEl.classList.add(S),
              this.contentEl &&
                (this.contentEl.classList.add(D),
            ...
            (this._isOpen = e),
              ...
              e
                ...
                : (this.el.classList.remove(M),
                  ...
                  this.contentEl &&
                    (this.contentEl.classList.remove(D),
                    this.contentEl.removeAttribute("aria-hidden")),
                  this.backdropEl && this.backdropEl.classList.remove(S),
          ...
          render() {
            ...
            return (0, i.h)(
              i.H,
              {
                ...
                onKeyDown: (0, w.shoudUseCloseWatcher)()
                  ? null
                  : this.onKeydown,
                role: "navigation",
        ...
        A = (e, t, n) => Math.max(0, t !== n ? -e : e),
        H = (e, t, n, r) => (n ? t >= e.innerWidth - r : t <= r),
        M = "show-menu",
        S = "show-backdrop",
        D = "menu-content-open";
      O.style = {
      ...
      const P = (function () {
          var e = (0, l.c)(function* (t) {
            const n = yield c.m.get(t);
        ...
        I = class {
          constructor(e) {
            ...
            (0, i.r)(this, e),
              (this.inheritedAttributes = {}),
              (this.onClick = (0, l.c)(function* () {
                return c.m.toggle(t.menu);
              })),
              (this.visible = !1),
              (this.color = void 0),
              (this.disabled = !1),
          ...
          visibilityChanged() {
            var e = this;
            return (0, l.c)(function* () {
              e.visible = yield P(e.menu);
            })();
          }
          render() {
            const { color: e, disabled: t, inheritedAttributes: n } = this,
              r = (0, o.b)(this),
              m = o.c.get("menuIcon", "ios" === r ? b.u : b.v),
              p = this.autoHide && !this.visible,
              u = { type: this.type },
              f = n["aria-label"] || "menu";
            return (0, i.h)(
              i.H,
              ...
              (0, i.h)(
                ...
                "md" === r &&
                  (0, i.h)("ion-ripple-effect", { type: "unbounded" }),
              ),
            );
          }
          get el() {
      ...
      const L = class {
        constructor(e) {
          (0, i.r)(this, e),
            (this.onClick = () => c.m.toggle(this.menu)),
            (this.visible = !1),
            (this.menu = void 0),
            (this.autoHide = !0);
        }
      ...
      L.style = ":host(.menu-toggle-hidden){display:none}";
    },
    5256: (j, v, s) => {
      s.d(v, { c: () => y, g: () => w, h: () => i, o: () => c });
      var l = s(1528);
      const i = (a, o) => null !== o.closest(a),
        y = (a, o) =>
          "string" == typeof a && a.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${a}`]: !0 }, o)
            : o,
        w = (a) => {
          const o = {};
          return (
        ...
        h = /^[a-z][a-z0-9+\-.]*:/,
        c = (function () {
          var a = (0, l.c)(function* (o, d, b, k) {
            if (null != o && "#" !== o[0] && !h.test(o)) {
              const x = document.querySelector("ion-router");
              if (x) return d?.preventDefault(), x.push(o, b, k);
            }
            return !1;
          });
          return function (d, b, k, x) {
