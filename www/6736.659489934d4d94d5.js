...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    6736: (E, p, r) => {
      r.r(p), r.d(p, { ion_action_sheet: () => _ });
      var b = r(1528),
        o = r(2992),
        f = r(436),
        v = r(6384),
        ...
        s = r(8523),
        n = r(388);
      r(5988), r(1008), r(4829), r(2528), r(6560), r(2784);
      const D = (t) => {
          const e = (0, n.c)(),
            i = (0, n.c)(),
            a = (0, n.c)();
        ...
        _ = class {
          constructor(t) {
            (0, o.r)(this, t),
              ...
              (this.delegateController = (0, d.d)(this)),
              (this.lockController = (0, k.c)()),
              (this.triggerController = (0, d.e)()),
              (this.presented = !1),
              (this.onBackdropTap = () => {
                this.dismiss(void 0, d.B);
              }),
              (this.dispatchCancelHandler = (e) => {
                if ((0, d.i)(e.detail.role)) {
                  const a = this.getButtons().find((h) => "cancel" === h.role);
          ...
          triggerChanged() {
            const { trigger: t, el: e, triggerController: i } = this;
          ...
          present() {
            ...
            return (0, b.c)(function* () {
              ...
              yield t.delegateController.attachViewToDom(),
                yield (0, d.f)(t, "actionSheetEnter", D, O),
                e();
            })();
          }
          dismiss(t, e) {
            var i = this;
            return (0, b.c)(function* () {
              const a = yield i.lockController.lock(),
                h = yield (0, d.g)(i, t, e, "actionSheetLeave", A, P);
              return h && i.delegateController.removeViewFromDom(), a(), h;
            })();
          }
          onDidDismiss() {
            return (0, d.h)(this.el, "ionActionSheetDidDismiss");
          }
          onWillDismiss() {
            return (0, d.h)(this.el, "ionActionSheetWillDismiss");
          }
          buttonClick(t) {
            var e = this;
            return (0, b.c)(function* () {
          ...
          callButtonHandler(t) {
            return (0, b.c)(function* () {
              return !(t && !1 === (yield (0, d.s)(t.handler)));
            })();
          }
          getButtons() {
          ...
          connectedCallback() {
            (0, d.j)(this.el), this.triggerChanged();
          }
            ...
            !this.gesture &&
              ...
              (0, o.e)(() => {
                t.scrollHeight > t.clientHeight ||
                  ((this.gesture = (0, f.c)(e, (a) =>
                    a.classList.contains("action-sheet-button"),
                  )),
                  this.gesture.enable(!0));
              }),
              !0 === this.isOpen && (0, v.r)(() => this.present()),
              this.triggerChanged();
          }
          render() {
            const { header: t, htmlAttributes: e, overlayIndex: i } = this,
              a = (0, s.b)(this),
              h = this.getButtons(),
              u = h.find((c) => "cancel" === c.role),
              I = h.filter((c) => "cancel" !== c.role),
              C = `action-sheet-${i}-header`;
            return (0, o.h)(
              o.H,
              Object.assign(
                {
                  ...
                  role: "dialog",
                  "aria-modal": "true",
                  "aria-labelledby": void 0 !== t ? C : null,
                  tabindex: "-1",
                },
                e,
                {
                  ...
                  class: Object.assign(
                    Object.assign({ [a]: !0 }, (0, g.g)(this.cssClass)),
                    {
                      "overlay-hidden": !0,
                  ...
                  (0, o.h)(
                    ...
                    I.map((c) =>
                      (0, o.h)(
                        ...
                        "md" === a && (0, o.h)("ion-ripple-effect", null),
                      ),
                    ),
                  ),
                  u &&
                    (0, o.h)(
                      ...
                      (0, o.h)(
                        "button",
                        Object.assign({}, u.htmlAttributes, {
                          type: "button",
                          class: w(u),
                          onClick: () => this.buttonClick(u),
                        }),
                        (0, o.h)(
                          "span",
                          { class: "action-sheet-button-inner" },
    ...
    5256: (E, p, r) => {
      r.d(p, { c: () => f, g: () => k, h: () => o, o: () => g });
      var b = r(1528);
      const o = (s, n) => null !== n.closest(s),
        f = (s, n) =>
          "string" == typeof s && s.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${s}`]: !0 }, n)
            : n,
        k = (s) => {
          const n = {};
          return (
        ...
        d = /^[a-z][a-z0-9+\-.]*:/,
        g = (function () {
          var s = (0, b.c)(function* (n, l, x, y) {
            if (null != n && "#" !== n[0] && !d.test(n)) {
              const m = document.querySelector("ion-router");
              if (m) return l?.preventDefault(), m.push(n, x, y);
            }
            return !1;
          });
          return function (l, x, y, m) {
