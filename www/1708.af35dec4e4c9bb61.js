...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    1708: (z, c, a) => {
      a.r(c), a.d(c, { ion_tab_bar: () => v, ion_tab_button: () => k });
      var h = a(1528),
        t = a(2992),
        p = a(4908),
        f = a(5256),
      ...
      const v = class {
        constructor(o) {
          (0, t.r)(this, o),
            (this.ionTabBarChanged = (0, t.d)(this, "ionTabBarChanged", 7)),
            (this.ionTabBarLoaded = (0, t.d)(this, "ionTabBarLoaded", 7)),
        ...
        connectedCallback() {
          ...
          return (0, h.c)(function* () {
            o.keyboardCtrl = yield (0, p.c)(
              (function () {
                var e = (0, h.c)(function* (s, l) {
                  !1 === s && void 0 !== l && (yield l),
                    (o.keyboardVisible = s);
                });
                return function (s, l) {
        ...
        render() {
          const { color: o, translucent: e, keyboardVisible: s } = this,
            l = (0, d.b)(this),
            g = s && "top" !== this.el.getAttribute("slot");
          return (0, t.h)(
            t.H,
            {
      ...
      const k = class {
        constructor(o) {
          (0, t.r)(this, o),
            (this.ionTabButtonClick = (0, t.d)(this, "ionTabButtonClick", 7)),
        ...
        onTabBarChanged(o) {
          const e = o.target,
            s = this.el.parentElement;
          (o.composedPath().includes(s) || e?.contains(this.el)) &&
            (this.selected = this.tab === o.detail.tab);
        }
        componentWillLoad() {
          (this.inheritedAttributes = Object.assign(
            {},
            (0, x.k)(this.el, ["aria-label"]),
          )),
            void 0 === this.layout &&
              (this.layout = d.c.get("tabButtonLayout", "icon-top"));
        }
        selectTab(o) {
          void 0 !== this.tab &&
            (this.disabled ||
          ...
          return (0, t.h)(
            t.H,
            {
              ...
              class: {
                ...
                "tab-has-label": s,
                "tab-has-icon": e,
                "tab-has-label-only": s && !e,
                "tab-has-icon-only": e && !s,
                [`tab-layout-${M}`]: !0,
                "ion-activatable": !0,
                "ion-selectable": !0,
                "ion-focusable": !0,
            ...
            (0, t.h)(
              ...
              Object.assign(
                ...
                { download: this.download, href: l, rel: g, target: E },
                {
                  class: "button-native",
                  part: "native",
                  role: "tab",
                  "aria-selected": _ ? "true" : null,
              ...
              "md" === C &&
                (0, t.h)("ion-ripple-effect", { type: "unbounded" }),
            ),
          );
        }
        get el() {
    ...
    5256: (z, c, a) => {
      a.d(c, { c: () => p, g: () => d, h: () => t, o: () => y });
      var h = a(1528);
      const t = (n, i) => null !== i.closest(n),
        p = (n, i) =>
          "string" == typeof n && n.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${n}`]: !0 }, i)
            : i,
        d = (n) => {
          const i = {};
          return (
        ...
        x = /^[a-z][a-z0-9+\-.]*:/,
        y = (function () {
          var n = (0, h.c)(function* (i, r, u, m) {
            if (null != i && "#" !== i[0] && !x.test(i)) {
              const b = document.querySelector("ion-router");
              if (b) return r?.preventDefault(), b.push(i, u, m);
            }
            return !1;
          });
          return function (r, u, m, b) {
