...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [1812],
  {
    1812: (B, f, n) => {
      ...
      const i = class {
        ...
        toggle() {
          var t = this;
          return (0, h.c)(function* () {
            t.el.querySelector("ion-fab-list") && (t.activated = !t.activated);
          })();
        }
        render() {
          const { horizontal: t, vertical: a, edge: s } = this,
            c = (0, l.b)(this);
          return (0, o.h)(
            o.H,
            {
        ...
        render() {
          ...
          return (0, o.h)(
            o.H,
            {
              ...
              class: (0, d.c)(s, {
                [C]: !0,
                "fab-button-in-list": z,
                "fab-button-translucent-in-list": z && w,
                "fab-button-close-active": m,
                "fab-button-show": L,
                "fab-button-disabled": a,
                "fab-button-translucent": w,
                "ion-activatable": !0,
                "ion-focusable": !0,
                [`fab-button-${_}`]: void 0 !== _,
              }),
            },
            (0, o.h)(
              E,
              Object.assign(
                ...
                I,
                {
                  ...
                  onBlur: this.onBlur,
                  onClick: (M) =>
                    (0, d.o)(c, M, this.routerDirection, this.routerAnimation),
                },
                A,
              ),
              (0, o.h)("ion-icon", {
              ...
              "md" === C && (0, o.h)("ion-ripple-effect", null),
            ),
          );
        }
        get el() {
    ...
    5256: (B, f, n) => {
      n.d(f, { c: () => l, g: () => d, h: () => o, o: () => x });
      var h = n(1528);
      const o = (r, i) => null !== i.closest(r),
        l = (r, i) =>
          "string" == typeof r && r.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${r}`]: !0 }, i)
            : i,
        d = (r) => {
          const i = {};
          return (
        ...
        g = /^[a-z][a-z0-9+\-.]*:/,
        x = (function () {
          var r = (0, h.c)(function* (i, e, p, v) {
            if (null != i && "#" !== i[0] && !g.test(i)) {
              const b = document.querySelector("ion-router");
              if (b) return e?.preventDefault(), b.push(i, p, v);
            }
            return !1;
          });
          return function (e, p, v, b) {
