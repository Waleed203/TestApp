...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [1492],
  {
      ...
      const n = class {
        ...
        render() {
          ...
          return (0, t.h)(
            ...
            "md" === o && (0, t.h)("ion-ripple-effect", null),
          );
        }
      };
      n.style = {
    ...
    5256: (h, a, r) => {
      r.d(a, { c: () => s, g: () => l, h: () => e, o: () => c });
      var t = r(1528);
      const e = (n, o) => null !== o.closest(n),
        s = (n, o) =>
          "string" == typeof n && n.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${n}`]: !0 }, o)
            : o,
        l = (n) => {
          const o = {};
          return (
        ...
        b = /^[a-z][a-z0-9+\-.]*:/,
        c = (function () {
          var n = (0, t.c)(function* (o, i, p, x) {
            if (null != o && "#" !== o[0] && !b.test(o)) {
              const d = document.querySelector("ion-router");
              if (d) return i?.preventDefault(), d.push(o, p, x);
            }
            return !1;
          });
          return function (i, p, x, d) {
