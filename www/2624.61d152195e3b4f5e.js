    ...
    2624: (u, a, d) => {
      ...
      const r = "split-pane-main",
        ...
        h = class {
          constructor(e) {
            (0, o.r)(this, e),
              (this.ionSplitPaneVisible = (0, o.d)(
                this,
                "ionSplitPaneVisible",
                7,
              )),
          ...
          visibleChanged(e) {
            const t = { visible: e, isPane: this.isPane.bind(this) };
          ...
          updateState() {
            ...
            const t = p[e] || e;
            if (0 === t.length) return void (this.visible = !1);
            const s = (n) => {
                this.visible = n.matches;
              },
              i = window.matchMedia(t);
            i.addListener(s),
              (this.rmL = () => i.removeListener(s)),
