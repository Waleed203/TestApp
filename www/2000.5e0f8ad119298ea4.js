...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [2e3],
  {
    2e3: (j, w, l) => {
      l.r(w),
        l.d(w, { ion_refresher: () => T, ion_refresher_content: () => U });
      var d = l(1528),
        n = l(2992),
        _ = l(6944),
        y = l(2816),
      ...
      const S = (e) => {
          const t = e.querySelector("ion-spinner"),
            ...
            a = e.querySelector(".arrow-container"),
            f = a ? a.querySelector("ion-icon") : null,
            o = (0, m.c)().duration(1e3).easing("ease-out"),
            i = (0, m.c)()
              .addElement(s)
              .keyframes([
        ...
        b = (e, t, r = 200) => {
          ...
          return (
            (0, n.w)(() => {
              e.style.setProperty("transition", `${r}ms all ease-out`),
                void 0 === t
        ...
        P = (function () {
          var e = (0, d.c)(function* (t, r) {
            const s = t.querySelector("ion-refresher-content");
            if (!s) return Promise.resolve(!1);
            yield new Promise((o) => (0, h.c)(s, o));
        ...
        T = class {
          constructor(e) {
            (0, n.r)(this, e),
              (this.ionRefresh = (0, n.d)(this, "ionRefresh", 7)),
              (this.ionPull = (0, n.d)(this, "ionPull", 7)),
              (this.ionStart = (0, n.d)(this, "ionStart", 7)),
          ...
          setupiOSNativeRefresher(e, t) {
            ...
            return (0, d.c)(function* () {
              ...
              let a = 0.16 * r.scrollEl.clientHeight;
              const f = s.length;
              (0, n.w)(() =>
                s.forEach((o) => o.style.setProperty("animation", "none")),
              ),
                (r.scrollListenerCallback = () => {
                  (!r.pointerDown && 1 === r.state) ||
                    (0, n.e)(() => {
                      const o = r.scrollEl.scrollTop,
                        i = r.el.clientHeight;
                      if (o > 0) {
                        if (8 === r.state) {
                          const u = (0, h.l)(0, o / (0.5 * i), 1);
                          return void (0, n.w)(() =>
                            ((e, t) => {
                      ...
                      8 === r.state || 1 === g
                        ? (r.pointerDown &&
                          ...
                          r.didRefresh ||
                            (r.beginRefresh(),
                            (r.didRefresh = !0),
                            (0, k.d)({ style: k.I.Light }),
                            r.pointerDown || b(r.elementToTransform, `${i}px`)))
                        : ((r.state = 2),
                          ((e, t, r) => {
                            (0, n.w)(() => {
                              e.forEach((a, f) => {
                                const o = f * (1 / t),
                                  g = (0, h.l)(0, (r - o) / (1 - o), 1);
                                a.style.setProperty("opacity", g.toString());
                              });
                            });
                          })(s, f, g));
                    });
                }),
                r.scrollEl.addEventListener("scroll", r.scrollListenerCallback),
                (r.gesture = (yield Promise.resolve().then(
                  ...
                  onStart: () => {
                    (r.pointerDown = !0),
                      r.didRefresh || b(r.elementToTransform, "0px"),
                      0 === a && (a = 0.16 * r.scrollEl.clientHeight);
                  },
                  onMove: (o) => {
                    r.lastVelocityY = o.velocityY;
                  },
                  onEnd: () => {
                    (r.pointerDown = !1),
                      (r.didStart = !1),
                      r.needsCompletion
                        ...
                        : r.didRefresh &&
                          (0, n.e)(() =>
                            b(r.elementToTransform, `${r.el.clientHeight}px`),
                          );
                  },
                })),
                r.disabledChanged();
          ...
          setupMDNativeRefresher(e, t, r) {
            var s = this;
            return (0, d.c)(function* () {
              const a = (0, h.g)(t).querySelector("circle"),
                f = s.el.querySelector(
                  "ion-refresher-content .refresher-pulling-icon",
                ),
                o = (0, h.g)(r).querySelector("circle");
              null !== a &&
                null !== o &&
                (0, n.w)(() => {
                ...
                (s.gesture = (yield Promise.resolve().then(
                  ...
                  onMove: (i) => {
                    if (
                      ...
                      if (!i.data.didStart) {
                        (i.data.didStart = !0), (s.state = 2);
                        const { scrollEl: p } = s,
                          g = p.matches(y.I) ? "overflow" : "--overflow";
                        (0, n.w)(() => p.style.setProperty(g, "hidden"));
                        const v = ((e) => {
                                  ...
                                  const r = t.clientHeight,
                                    s = (0, m.c)()
                                      ...
                                      .keyframes([
                                        {
                                          offset: 0,
                                          transform: `scale(0) translateY(-${r}px)`,
                                        },
                                        {
                                          offset: 1,
                                          transform:
                        ...
                        return (
                          ...
                          u.progressStart(!1, 0),
                          s.ionStart.emit(),
                          void s.animations.push(u)
                        );
                      }
                      (s.progress = (0, h.l)(0, (i.deltaY / 180) * 0.5, 1)),
                        i.data.animation.progressStep(s.progress),
                        s.ionPull.emit();
                    }
                  },
                  onEnd: (i) => {
                    if (!i.data.didStart) return;
                    s.gesture.enable(!1);
                    const { scrollEl: p } = s,
                      g = p.matches(y.I) ? "overflow" : "--overflow";
                    if (
                      ((0, n.w)(() => p.style.removeProperty(g)),
                      s.progress <= 0.4)
                    )
                      return void i.data.animation
                      ...
                      (0, n.w)(
                        (0, d.c)(function* () {
                          f.style.setProperty(
                            ...
                            i.data.animation.progressEnd(),
                            yield u.play(),
                            s.beginRefresh(),
                            i.data.animation.destroy(),
                            s.gesture.enable(!0);
                        }),
                      );
                  },
          ...
          connectedCallback() {
            ...
            return (0, d.c)(function* () {
              ...
              const t = e.el.closest(y.b);
              t
                ? (0, h.c)(
                    t,
                    (0, d.c)(function* () {
                      const r = t.querySelector(y.I);
                      (e.scrollEl = yield (0, y.g)(r ?? t)),
                        (e.backgroundContentEl =
                          yield t.getBackgroundElement()),
                        (yield P(e.el, (0, c.b)(e)))
            ...
            this.nativeRefresher ||
              ...
              (0, n.w)(() => {
                if (this.scrollEl && this.backgroundContentEl) {
                  const f = this.scrollEl.style,
                    o = this.backgroundContentEl.style;
                  (f.transform = o.transform =
                    e > 0 ? `translateY(${e}px) translateZ(0px)` : ""),
                    (f.transitionDuration = o.transitionDuration = t),
                    (f.transitionDelay = o.transitionDelay = s),
                    (f.overflow = r ? "hidden" : "");
                }
                a && this.restoreOverflowStyle();
              }));
          }
      ...
      const U = class {
        ...
        componentWillLoad() {
          if (void 0 === this.pullingIcon) {
            const e = R(),
              t = (0, c.b)(this);
            this.pullingIcon = c.c.get(
              "refreshingIcon",
              "ios" === t && e
                ? c.c.get("spinner", e ? "lines" : E.i)
                : "circular",
            );
          }
          if (void 0 === this.refreshingSpinner) {
            const e = (0, c.b)(this);
            this.refreshingSpinner = c.c.get(
              "refreshingSpinner",
              c.c.get("spinner", "ios" === e ? "lines" : "circular"),
            );
          }
        }
        renderPullingText() {
          ...
          return e
            ...
            : (0, n.h)("div", { class: "refresher-pulling-text" }, t);
        }
        renderRefreshingText() {
          ...
          return e
            ...
            : (0, n.h)("div", { class: "refresher-refreshing-text" }, t);
        }
        render() {
          const e = this.pullingIcon,
            t = null != e && void 0 !== C.S[e],
            r = (0, c.b)(this);
          return (0, n.h)(
            n.H,
            { key: "537e4d601fd09804d072e9fed9b2c6ba8d890548", class: r },
            (0, n.h)(
              "div",
              {
            ...
            (0, n.h)(
              ...
              this.refreshingSpinner &&
                (0, n.h)(
                  ...
                  (0, n.h)("ion-spinner", { name: this.refreshingSpinner }),
                ),
