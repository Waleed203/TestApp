...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [3752],
  {
      ...
      const b = class {
        constructor(r) {
          (0, e.r)(this, r),
            ...
            (this.ionStyle = (0, e.d)(this, "ionStyle", 7)),
            (this.inputId = "ion-cb-" + g++),
            (this.inheritedAttributes = {}),
            (this.hasLoggedDeprecationWarning = !1),
            (this.setChecked = (t) => {
              const a = (this.checked = t);
              this.ionChange.emit({ checked: a, value: this.value });
            }),
        ...
        connectedCallback() {
          this.legacyFormController = (0, w.c)(this.el);
        }
        componentWillLoad() {
          this.emitStyle(),
        ...
        emitStyle() {
          ...
          this.legacyFormController.hasLegacyControl() &&
            ...
            this.ionStyle.emit(r);
        }
        setFocus() {
          this.focusEl && this.focusEl.focus();
        }
        render() {
          const { legacyFormController: r } = this;
          return r.hasLegacyControl()
          ...
          return (
            ...
            (0, e.h)(
              e.H,
              {
                class: (0, h.c)(r, {
                  [u]: !0,
                  "in-item": (0, h.h)("ion-item", l),
                  "checkbox-checked": t,
                  "checkbox-disabled": a,
                  "checkbox-indeterminate": p,
                  interactive: !0,
                  [`checkbox-justify-${C}`]: !0,
                  [`checkbox-alignment-${j}`]: !0,
                  [`checkbox-label-placement-${f}`]: !0,
                }),
                ...
                (0, e.h)(
                  "div",
                  {
                    class: {
                      ...
                      "label-text-wrapper-hidden": "" === l.textContent,
                    },
                    part: "label",
                  },
                  (0, e.h)("slot", null),
        ...
        renderLegacyCheckbox() {
          ...
          const {
            ...
            f = (0, m.b)(this),
            { label: _, labelId: E, labelText: j } = (0, s.e)(l, d),
            u = y(f, p);
          return (
            (0, s.d)(!0, l, v, t ? C : "", a),
            (0, e.h)(
        ...
        static get watchers() {
          return { checked: ["styleChanged"], disabled: ["styleChanged"] };
        }
      };
      let g = 0;
      b.style = {
    ...
    5256: (L, x, n) => {
      n.d(x, { c: () => s, g: () => h, h: () => w, o: () => D });
      var e = n(1528);
      const w = (o, c) => null !== c.closest(o),
        s = (o, c) =>
          "string" == typeof o && o.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${o}`]: !0 }, c)
            : c,
        h = (o) => {
          const c = {};
          return (
        ...
        m = /^[a-z][a-z0-9+\-.]*:/,
        D = (function () {
          var o = (0, e.c)(function* (c, i, b, g) {
            if (null != c && "#" !== c[0] && !m.test(c)) {
              const r = document.querySelector("ion-router");
              if (r) return i?.preventDefault(), r.push(c, b, g);
            }
            return !1;
          });
          return function (i, b, g, r) {
