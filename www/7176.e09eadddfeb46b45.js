...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    7176: (I, x, c) => {
      c.r(x), c.d(x, { ion_radio: () => b, ion_radio_group: () => D });
      var g = c(1528),
        r = c(2992),
        k = c(8507),
        h = c(6384),
      ...
      const b = class {
            ...
            (this.onClick = () => {
              ...
              if (!a) {
                if (this.legacyFormController.hasLegacyControl())
                  return void (this.checked = this.nativeInput.checked);
                this.checked = !i || !t?.allowEmptySelection;
              }
            }),
            (this.onFocus = () => {
              this.ionFocus.emit();
        ...
        renderLegacyRadio() {
          ...
          const {
            ...
            l = (0, o.b)(this),
            { label: u, labelId: C, labelText: E } = (0, h.e)(s, e);
          return (0, r.h)(
            r.H,
            {
              "aria-checked": `${i}`,
      ...
      const D = class {
        constructor(e) {
          (0, r.r)(this, e),
            ...
            (this.inputId = "ion-rg-" + R++),
            (this.labelId = `${this.inputId}-lbl`),
            (this.setRadioTabindex = (t) => {
              const i = this.getRadios(),
                a = i.find((l) => !l.disabled),
                s = i.find((l) => l.value === t && !l.disabled);
              if (!a && !s) return;
              const d = s || a;
              for (const l of i) l.setButtonTabindex(l === d ? 0 : -1);
            }),
            (this.onClick = (t) => {
              t.preventDefault();
              ...
              if (i && !i.disabled) {
                const s = i.value;
                s !== this.value
                  ? ((this.value = s), this.emitValueChange(t))
        ...
        onKeydown(e) {
          ...
          if (e.target && i.includes(e.target)) {
            const a = i.findIndex((l) => l === e.target),
              s = i[a];
            let d;
            if (
              (["ArrowDown", "ArrowRight"].includes(e.key) &&
                (d = a === i.length - 1 ? i[0] : i[a + 1]),
              ["ArrowUp", "ArrowLeft"].includes(e.key) &&
                (d = 0 === a ? i[i.length - 1] : i[a - 1]),
              d &&
                i.includes(d) &&
                (d.setFocus(e),
                t || ((this.value = d.value), this.emitValueChange(e))),
              [" "].includes(e.key))
            ) {
              const l = this.value;
              (this.value =
                this.allowEmptySelection && void 0 !== this.value
                  ? void 0
                  : s.value),
                (l !== this.value || this.allowEmptySelection) &&
        ...
        render() {
          const { label: e, labelId: t, el: i, name: a, value: s } = this,
            d = (0, o.b)(this);
          return (
            (0, h.d)(!0, i, a, s, !1),
            (0, r.h)(r.H, {
    ...
    5256: (I, x, c) => {
      c.d(x, { c: () => k, g: () => v, h: () => r, o: () => m });
      var g = c(1528);
      const r = (o, n) => null !== n.closest(o),
        k = (o, n) =>
          "string" == typeof o && o.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${o}`]: !0 }, n)
            : n,
        v = (o) => {
          const n = {};
          return (
        ...
        w = /^[a-z][a-z0-9+\-.]*:/,
        m = (function () {
          var o = (0, g.c)(function* (n, p, _, y) {
            if (null != n && "#" !== n[0] && !w.test(n)) {
              const b = document.querySelector("ion-router");
              if (b) return p?.preventDefault(), b.push(n, _, y);
            }
            return !1;
          });
          return function (p, _, y, b) {
