...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    9580: (F, m, c) => {
      c.r(m), c.d(m, { ion_button: () => E, ion_icon: () => M });
      var e = c(2992),
        k = c(6384),
        f = c(2032),
        u = c(5256),
      ...
      const l = (o, t, n, i, r) => (
          ...
          i && "ios" === n
            ...
            : r && "md" === n
              ? (o = y(r))
              : (!o && t && !g(t) && (o = t), d(o) && (o = y(o))),
          d(o) && "" !== o.trim() && "" === o.replace(/[a-z]|-|\d/gi, "")
            ? o
            : null
        ),
        h = (o) => (d(o) && ((o = o.trim()), g(o)) ? o : null),
        ...
        E = class {
          ...
          componentWillLoad() {
            (this.inToolbar = !!this.el.closest("ion-buttons")),
              ...
              (this.inheritedAttributes = (0, k.i)(this.el));
          }
          get hasIconOnly() {
            ...
            if ("string" == typeof o) {
              ...
              return t
                ? t instanceof HTMLFormElement
                  ? t
                  : ((0, f.p)(
                      `Form with selector: "#${o}" could not be found. Verify that the id is attached to a <form> element.`,
                      this.el,
                    ),
                    null)
                : ((0, f.p)(
                    `Form with selector: "#${o}" could not be found. Verify that the id is correct and the form is rendered in the DOM.`,
                    this.el,
                  ),
                  null);
            }
          ...
          submitForm(o) {
            this.formEl &&
              this.formButtonEl &&
              (o.preventDefault(), this.formButtonEl.click());
          }
          render() {
            const o = (0, w.b)(this),
              {
              ...
              T = void 0 === v && this.inItem ? "small" : v,
              D = void 0 === B ? "button" : "a",
              Y =
                "button" === D
                  ? { type: n }
                  : { download: this.download, href: B, rel: r, target: x };
            let _ = this.fill;
            return (
              null == _ &&
                (_ = this.inToolbar || this.inListHeader ? "clear" : "solid"),
              ...
              (0, e.h)(
                e.H,
                {
                  ...
                  class: (0, u.c)(G, {
                    ...
                    [`${t}-${_}`]: !0,
                    [`${t}-strong`]: J,
                    "in-toolbar": (0, u.h)("ion-toolbar", this.el),
                ...
                (0, e.h)(
                  ...
                  "md" === o &&
                    (0, e.h)("ion-ripple-effect", { type: this.rippleType }),
                ),
              )
            );
          }
          ...
          loadIcon() {
            if (this.isVisible) {
              const o = ((o) => {
                ...
                return (
                  t ||
                  ((t = l(o.name, o.icon, o.mode, o.ios, o.md)),
                  t
                    ? ((o, t) => {
                        const n = (() => {
                    ...
                    : o.icon &&
                        ((t = h(o.icon)), t || ((t = h(o.icon[o.mode])), t))
                      ? t
                      : null)
                );
              })(this);
              o &&
                (b.has(o)
                  ? (this.svgContent = b.get(o))
                  : ((o, t) => {
                      let n = L.get(o);
                      if (!n) {
                        if (!(typeof fetch < "u" && typeof document < "u"))
                          return b.set(o, ""), Promise.resolve();
                        if (
                          ...
                          const r = z
                            ...
                            .querySelector("svg");
                          return r && b.set(o, r.outerHTML), Promise.resolve();
                        }
                        (n = fetch(o).then((i) => {
                          if (i.ok)
    ...
    5256: (F, m, c) => {
      c.d(m, { c: () => f, g: () => w, h: () => k, o: () => C });
      var e = c(1528);
      const k = (a, s) => null !== s.closest(a),
        f = (a, s) =>
          "string" == typeof a && a.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${a}`]: !0 }, s)
            : s,
        w = (a) => {
          const s = {};
          return (
        ...
        p = /^[a-z][a-z0-9+\-.]*:/,
        C = (function () {
          var a = (0, e.c)(function* (s, l, h, g) {
            if (null != s && "#" !== s[0] && !p.test(s)) {
              const d = document.querySelector("ion-router");
              if (d) return l?.preventDefault(), d.push(s, h, g);
            }
            return !1;
          });
