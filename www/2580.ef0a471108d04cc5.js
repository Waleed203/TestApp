...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [2580],
  {
      ...
      const m = class {
        constructor(r) {
          ...
          (0, n.r)(this, r),
            ...
            (this.ionCancel = (0, n.d)(this, "ionCancel", 7)),
            (this.ionClear = (0, n.d)(this, "ionClear", 7)),
            ...
            (this.inputId = "ion-searchbar-" + g++),
            (this.onClearInput = (function () {
              var a = (0, d.c)(function* (o) {
                return (
                  e.ionClear.emit(),
                  new Promise((s) => {
                    setTimeout(() => {
            ...
            (this.onInput = (a) => {
              const o = a.target;
              o && (this.value = o.value), this.emitInputChange(a);
            }),
            (this.onChange = (a) => {
              this.emitValueChange(a);
            }),
            (this.onBlur = (a) => {
              (this.focused = !1),
                this.ionBlur.emit(),
                this.positionElements(),
                this.focusedValue !== this.value && this.emitValueChange(a),
            ...
            (this.cancelButtonIcon = p.c.get("backButtonIcon", b.a)),
        ...
        debounceChanged() {
          const { ionInput: r, debounce: e, originalIonInput: a } = this;
          this.ionInput = void 0 === e ? a ?? r : (0, f.j)(r, e);
        }
        valueChanged() {
          const r = this.nativeInput,
            e = this.getValue();
          r && r.value !== e && (r.value = e);
        }
        showCancelButtonChanged() {
          requestAnimationFrame(() => {
            this.positionElements(), (0, n.i)(this);
          });
        }
        connectedCallback() {
          this.emitStyle();
        ...
        setFocus() {
          ...
          return (0, d.c)(function* () {
            r.nativeInput && r.nativeInput.focus();
          })();
        }
        getInputElement() {
          var r = this;
          return (0, d.c)(function* () {
            return (
              r.nativeInput || (yield new Promise((e) => (0, f.c)(r.el, e))),
              Promise.resolve(r.nativeInput)
            );
          })();
        }
        emitValueChange(r) {
          const { value: e } = this,
            a = null == e ? e : e.toString();
          (this.focusedValue = a), this.ionChange.emit({ value: a, event: r });
        }
        emitInputChange(r) {
          const { value: e } = this;
          this.ionInput.emit({ value: e, event: r });
        }
        positionElements() {
          const r = this.getValue(),
            e = this.shouldAlignLeft,
            a = (0, p.b)(this),
            o = !this.animated || "" !== r.trim() || !!this.focused;
        ...
        positionPlaceholder() {
          ...
          if (this.shouldAlignLeft)
            r.removeAttribute("style"), a.removeAttribute("style");
          else {
            const o = document,
              s = o.createElement("span");
            (s.innerText = this.placeholder || ""),
              o.body.appendChild(s),
              (0, f.r)(() => {
                const l = s.offsetWidth;
                s.remove();
                const v = "calc(50% - " + l / 2 + "px)",
                  u = "calc(50% - " + (l / 2 + a.clientWidth + 8) + "px)";
                e
                  ? ((r.style.paddingRight = v), (a.style.marginRight = u))
                  : ((r.style.paddingLeft = v), (a.style.marginLeft = u));
              });
          }
        }
        positionCancelButton() {
          const r = (0, x.i)(this.el),
            e = (this.el.shadowRoot || this.el).querySelector(
              ".searchbar-cancel-button",
            ),
            a = this.shouldShowCancelButton();
          if (null !== e && a !== this.isCancelVisible) {
            const o = e.style;
            if (((this.isCancelVisible = a), a))
              r ? (o.marginLeft = "0") : (o.marginRight = "0");
            else {
              const s = e.offsetWidth;
              s > 0 &&
                (r ? (o.marginLeft = -s + "px") : (o.marginRight = -s + "px"));
            }
          }
        }
        getValue() {
        ...
        render() {
          const { cancelButtonText: r } = this,
            e = this.animated && p.c.getBoolean("animated", !0),
            a = (0, p.b)(this),
            o = this.clearIcon || ("ios" === a ? b.b : b.d),
            s = this.searchIcon || ("ios" === a ? b.s : b.e),
            l = this.shouldShowCancelButton(),
            v =
              "never" !== this.showCancelButton &&
              (0, n.h)(
                "button",
    ...
    5256: (C, y, c) => {
      c.d(y, { c: () => f, g: () => k, h: () => n, o: () => p });
      var d = c(1528);
      const n = (i, t) => null !== t.closest(i),
        f = (i, t) =>
          "string" == typeof i && i.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${i}`]: !0 }, t)
            : t,
        k = (i) => {
          const t = {};
          return (
        ...
        b = /^[a-z][a-z0-9+\-.]*:/,
        p = (function () {
          var i = (0, d.c)(function* (t, h, w, m) {
            if (null != t && "#" !== t[0] && !b.test(t)) {
              const g = document.querySelector("ion-router");
              if (g) return h?.preventDefault(), g.push(t, w, m);
            }
            return !1;
          });
          return function (h, w, m, g) {
