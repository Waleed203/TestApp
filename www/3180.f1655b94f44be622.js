...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [3180],
  {
      ...
      const U = class {
          constructor(t) {
            ...
            (0, r.r)(this, t),
              ...
              (this.ionInput = (0, r.d)(this, "ionInput", 7)),
              (this.ionStyle = (0, r.d)(this, "ionStyle", 7)),
              (this.ionFocus = (0, r.d)(this, "ionFocus", 7)),
              (this.ionBlur = (0, r.d)(this, "ionBlur", 7)),
              (this.ionKnobMoveStart = (0, r.d)(this, "ionKnobMoveStart", 7)),
              (this.ionKnobMoveEnd = (0, r.d)(this, "ionKnobMoveEnd", 7)),
              (this.rangeId = "ion-r-" + G++),
              (this.didLoad = !1),
              (this.noUpdate = !1),
              (this.hasFocus = !1),
              ...
              (this.clampBounds = (n) => (0, h.l)(this.min, n, this.max)),
              (this.ensureValueInBounds = (n) =>
                this.dualKnobs
                  ? {
                      lower: this.clampBounds(n.lower),
                      upper: this.clampBounds(n.upper),
                    }
                  : this.clampBounds(n)),
              (this.setupGesture = (0, R.c)(function* () {
                const n = e.rangeSlider;
                n &&
              ...
              (this.handleKeyboard = (n, a) => {
                const { ensureValueInBounds: i } = this;
                let o = this.step;
                (o = o > 0 ? o : 1),
                  (o /= this.max - this.min),
                  a || (o *= -1),
                  "A" === n
                    ? (this.ratioA = (0, h.l)(0, this.ratioA + o, 1))
                    : (this.ratioB = (0, h.l)(0, this.ratioB + o, 1)),
                  this.ionKnobMoveStart.emit({ value: i(this.value) }),
                  this.updateValue(),
                  this.emitValueChange(),
                  this.ionKnobMoveEnd.emit({ value: i(this.value) });
              }),
              (this.onBlur = () => {
                this.hasFocus &&
                  ((this.hasFocus = !1), this.ionBlur.emit(), this.emitStyle());
              }),
              (this.onFocus = () => {
                this.hasFocus ||
                  ((this.hasFocus = !0),
              ...
              (this.max = 100),
              (this.pin = !1),
              (this.pinFormatter = (n) => Math.round(n)),
              (this.snaps = !1),
              (this.step = 1),
              (this.ticks = !0),
          ...
          debounceChanged() {
            const { ionInput: t, debounce: e, originalIonInput: n } = this;
            this.ionInput = void 0 === e ? n ?? t : (0, h.j)(t, e);
          }
          minChanged() {
          ...
          activeBarStartChanged() {
            const { activeBarStart: t } = this;
            void 0 !== t &&
              (t > this.max
                ? ((0, y.p)(
                    `Range: The value of activeBarStart (${t}) is greater than the max (${this.max}). Valid values are greater than or equal to the min value and less than or equal to the max value.`,
                    this.el,
                  ),
                  (this.activeBarStart = this.max))
                : t < this.min &&
                  ((0, y.p)(
                    `Range: The value of activeBarStart (${t}) is less than the min (${this.min}). Valid values are greater than or equal to the min value and less than or equal to the max value.`,
                    this.el,
                  ),
          ...
          connectedCallback() {
            const { el: t } = this;
            (this.legacyFormController = (0, L.c)(t)),
              this.updateRatio(),
              this.debounceChanged(),
              this.disabledChanged(),
              this.activeBarStartChanged(),
              this.didLoad && this.setupGesture(),
              (this.contentEl = (0, z.f)(this.el));
          }
          ...
          getValue() {
            var t;
            const e = null !== (t = this.value) && void 0 !== t ? t : 0;
          ...
          onStart(t) {
            ...
            e && (this.initialContentScrollY = (0, z.d)(e));
            const n = (this.rect = this.rangeSlider.getBoundingClientRect()),
              a = t.currentX;
            let i = (0, h.l)(0, (a - n.left) / n.width, 1);
            (0, S.i)(this.el) && (i = 1 - i),
              (this.pressedKnob =
                !this.dualKnobs ||
                Math.abs(this.ratioA - i) < Math.abs(this.ratioB - i)
                  ? "A"
                  : "B"),
          ...
          onEnd(t) {
            const { contentEl: e, initialContentScrollY: n } = this;
            e && (0, z.r)(e, n),
              this.update(t.currentX),
              (this.pressedKnob = void 0),
              this.emitValueChange(),
          ...
          update(t) {
            const e = this.rect;
            let n = (0, h.l)(0, (t - e.left) / e.width, 1);
            (0, S.i)(this.el) && (n = 1 - n),
              this.snaps &&
                (n = _(
                  j(n, this.min, this.max, this.step),
                  this.min,
                  this.max,
                )),
              "A" === this.pressedKnob ? (this.ratioA = n) : (this.ratioB = n),
              this.updateValue();
          }
          get valA() {
            return j(this.ratioA, this.min, this.max, this.step);
          }
          get valB() {
            return j(this.ratioB, this.min, this.max, this.step);
          }
          get ratioLower() {
            if (this.dualKnobs) return Math.min(this.ratioA, this.ratioB);
            const { activeBarStart: t } = this;
            return null == t ? 0 : _(t, this.min, this.max);
          }
          get ratioUpper() {
            return this.dualKnobs
          ...
          updateRatio() {
            const t = this.getValue(),
              { min: e, max: n } = this;
            this.dualKnobs
              ? ((this.ratioA = _(t.lower, e, n)),
                (this.ratioB = _(t.upper, e, n)))
              : (this.ratioA = _(t, e, n));
          }
          updateValue() {
            this.noUpdate = !0;
          ...
          renderLegacyRange() {
            ...
            const {
              ...
              o = (0, l.b)(this);
            return (
              (0, h.d)(!0, t, this.name, JSON.stringify(this.getValue()), n),
              (0, r.h)(
                r.H,
                {
                  ...
                  class: (0, s.c)(this.color, {
                    [o]: !0,
                    "in-item": (0, s.h)("ion-item", t),
                    "range-disabled": n,
                    "range-pressed": void 0 !== e,
                    "range-has-pin": a,
                    "legacy-range": !0,
                  }),
                },
                (0, r.h)("slot", { name: "start" }),
          ...
          renderRange() {
            const {
              ...
              E = f && !((n && "end" === p) || this.hasEndSlotContent),
              C = (0, l.b)(this);
            return (
              (0, h.d)(!0, e, this.name, JSON.stringify(this.getValue()), t),
              (0, r.h)(
                r.H,
                {
                  onFocusin: this.onFocus,
                  ...
                  class: (0, s.c)(this.color, {
                    ...
                    "in-item": f,
                    "range-disabled": t,
                    "range-pressed": void 0 !== o,
                    "range-has-pin": i,
                    [`range-label-placement-${p}`]: !0,
                    "range-item-start-adjustment": m,
                    "range-item-end-adjustment": E,
                  }),
                },
                (0, r.h)(
                  "label",
                  { class: "range-wrapper", id: "range-label" },
                  (0, r.h)(
                    "div",
                    {
                      class: {
                        "label-text-wrapper": !0,
                        "label-text-wrapper-hidden": !n,
                      },
                      part: "label",
                    },
                    void 0 !== k
                      ? (0, r.h)("div", { class: "label-text" }, k)
                      : (0, r.h)("slot", { name: "label" }),
                  ),
                  (0, r.h)(
                    "div",
          ...
          renderRangeSlider() {
            ...
            let { labelText: w } = (0, h.e)(i, E);
            null == w && (w = v["aria-label"]);
            let b = 100 * u + "%",
              x = 100 - 100 * m + "%";
            const I = (0, S.i)(this.el),
              K = I ? "right" : "left",
              X = (c) => ({ [K]: c[K] });
            !1 === this.dualKnobs &&
              (this.valA <
              (null !== (t = this.activeBarStart) && void 0 !== t
                ? t
                : this.min)
                ? ((b = 100 * m + "%"), (x = 100 - 100 * u + "%"))
                : ((b = 100 * u + "%"), (x = 100 - 100 * m + "%")));
            const H = { [K]: b, [I ? "left" : "right"]: x },
              F = [];
            ...
            return (
              ...
              (0, r.h)(
                "div",
                { class: "range-slider", ref: (c) => (this.rangeSlider = c) },
                F.map((c) =>
                  (0, r.h)("div", {
                    style: X(c),
                    role: "presentation",
                    class: { "range-tick": !0, "range-tick-active": c.active },
                    part: c.active ? "tick-active" : "tick",
                  }),
                ),
                (0, r.h)(
                  "div",
        ...
        T = (
          ...
          const C = t ? "right" : "left";
          return (0, r.h)(
            "div",
            {
              onKeyDown: (b) => {
                const x = b.key;
                "ArrowLeft" === x || "ArrowDown" === x
                  ? (u(e, !1), b.preventDefault(), b.stopPropagation())
                  : ("ArrowRight" === x || "ArrowUp" === x) &&
                    (u(e, !0), b.preventDefault(), b.stopPropagation());
              },
              class: {
                "range-knob-handle": !0,
                "range-knob-a": "A" === e,
                "range-knob-b": "B" === e,
                "range-knob-pressed": k,
                "range-knob-min": n === i,
                "range-knob-max": n === o,
                "ion-activatable": !0,
                "ion-focusable": !0,
              ...
              role: "slider",
              tabindex: p ? -1 : 0,
              "aria-label": void 0 === v ? m : null,
              "aria-labelledby": void 0 !== v ? v : null,
              "aria-valuemin": i,
              "aria-valuemax": o,
        ...
        j = (t, e, n, a) => {
          let i = (n - e) * t;
          return (
            a > 0 && (i = Math.round(i / a) * a + e),
            (function A(t, ...e) {
              const n = Math.max(
                ...e.map((a) =>
                  (function g(t) {
                    return t % 1 == 0 ? 0 : t.toString().split(".")[1].length;
                  })(a),
                ),
              );
    ...
    5256: ($, M, d) => {
      d.d(M, { c: () => z, g: () => h, h: () => r, o: () => S });
      var R = d(1528);
      const r = (s, l) => null !== l.closest(s),
        z = (s, l) =>
          "string" == typeof s && s.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${s}`]: !0 }, l)
            : l,
        h = (s) => {
          const l = {};
          return (
        ...
        y = /^[a-z][a-z0-9+\-.]*:/,
        S = (function () {
          var s = (0, R.c)(function* (l, g, A, P) {
            if (null != l && "#" !== l[0] && !y.test(l)) {
              const B = document.querySelector("ion-router");
              if (B) return g?.preventDefault(), B.push(l, A, P);
            }
            return !1;
          });
          return function (g, A, P, B) {
