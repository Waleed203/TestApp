...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [6932],
  {
      ...
      const c = class {
        constructor(r) {
          ...
          (0, e.r)(this, r),
            ...
            (this.onClick = (function () {
              var h = (0, b.c)(function* (l) {
                const p = a.el.closest("ion-nav");
                return (
                  l.preventDefault(),
                  p && (yield p.canGoBack())
                    ? p.pop({
                        animationBuilder: a.routerAnimation,
                        skipIfBusy: !0,
                      })
                    : (0, d.o)(a.defaultHref, l, "back", a.routerAnimation)
                );
              });
              return function (l) {
        ...
        componentWillLoad() {
          (this.inheritedAttributes = (0, m.i)(this.el)),
            void 0 === this.defaultHref &&
              (this.defaultHref = s.c.get("backButtonDefaultHref"));
        }
        get backButtonIcon() {
          return (
            this.icon ??
            ("ios" === (0, s.b)(this)
              ? s.c.get("backButtonIcon", g.c)
              : s.c.get("backButtonIcon", g.a))
          );
        }
        get backButtonText() {
          const r = "ios" === (0, s.b)(this) ? "Back" : null;
          return null != this.text ? this.text : s.c.get("backButtonText", r);
        }
        get hasIconOnly() {
        ...
        render() {
          const {
              ...
              backButtonText: v,
              icon: w,
              inheritedAttributes: _,
            } = this,
            B = void 0 !== a,
            y = (0, s.b)(this),
            C = _["aria-label"] || v || "back";
          return (0, e.h)(
            e.H,
            {
              ...
              class: (0, d.c)(r, {
                [y]: !0,
                button: !0,
                "back-button-disabled": h,
                "back-button-has-icon-only": p,
    ...
    5256: (x, u, i) => {
      i.d(u, { c: () => m, g: () => g, h: () => e, o: () => f });
      var b = i(1528);
      const e = (n, t) => null !== t.closest(n),
        m = (n, t) =>
          "string" == typeof n && n.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${n}`]: !0 }, t)
            : t,
        g = (n) => {
          const t = {};
          return (
        ...
        s = /^[a-z][a-z0-9+\-.]*:/,
        f = (function () {
          var n = (0, b.c)(function* (t, o, c, r) {
            if (null != t && "#" !== t[0] && !s.test(t)) {
              const a = document.querySelector("ion-router");
              if (a) return o?.preventDefault(), a.push(t, c, r);
            }
            return !1;
          });
          return function (o, c, r, a) {
