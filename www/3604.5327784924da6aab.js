...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    3604: (B, m, i) => {
      i.r(m), i.d(m, { ion_reorder: () => g, ion_reorder_group: () => I });
      var y = i(1528),
        l = i(2992),
        u = i(4812),
        E = i(8523),
      ...
      const g = class {
        ...
        onClick(e) {
          const t = this.el.closest("ion-reorder-group");
          e.preventDefault(),
            (!t || !t.disabled) && e.stopImmediatePropagation();
        }
        render() {
          const e = (0, E.b)(this);
          return (0, l.h)(
            l.H,
            { key: "e625707b1810f93f5c667e38b8e2904988a3cff0", class: e },
            (0, l.h)(
              "slot",
      ...
      const I = class {
          ...
          onStart(e) {
            ...
            if (
              ...
              (this.scrollElInitial = this.scrollEl.scrollTop),
                (this.scrollElTop = d.top + b),
                (this.scrollElBottom = d.bottom - b);
            } else
              (this.scrollElInitial = 0),
                (this.scrollElTop = 0),
                (this.scrollElBottom = 0);
          ...
          onMove(e) {
            ...
            if (a !== this.lastToIndex) {
              const P = h(t);
              (this.lastToIndex = a), (0, f.b)(), this.reorderMove(P, a);
            }
