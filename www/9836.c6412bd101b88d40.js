  ...
  [9836],
  {
    9836: (z, C, c) => {
      ...
      var y = c(1528),
        ...
        D = c(2528);
      c(2784), c(6560);
      const O = (t, e) => Math.floor(t / 2 - e / 2),
        K = (t, e) => {
          const n = (0, d.c)(),
            o = (0, d.c)(),
            { position: r, top: i, bottom: u } = e,
            a = (0, b.g)(t).querySelector(".toast-wrapper");
          switch ((o.addElement(a), r)) {
            case "top":
              o.fromTo("transform", "translateY(-100%)", `translateY(${i})`);
              break;
            case "middle":
              const g = O(t.clientHeight, a.clientHeight);
              (a.style.top = `${g}px`), o.fromTo("opacity", 0.01, 1);
              break;
            default:
              o.fromTo("transform", "translateY(100%)", `translateY(${u})`);
          }
          return n
        ...
        F = (t, e) => {
          ...
          switch ((o.addElement(a), r)) {
            case "top":
              o.fromTo("transform", `translateY(${i})`, "translateY(-100%)");
              break;
            case "middle":
              o.fromTo("opacity", 0.99, 0);
              break;
            default:
              o.fromTo("transform", `translateY(${u})`, "translateY(100%)");
          }
          return n
        ...
        N = (t, e) => {
          ...
          switch ((o.addElement(a), r)) {
            case "top":
              a.style.setProperty("transform", `translateY(${i})`),
            ...
            case "middle":
              ...
              break;
            default:
              a.style.setProperty("transform", `translateY(${u})`),
                o.fromTo("opacity", 0.01, 1);
          }
          return n
            .easing("cubic-bezier(.36,.66,.04,1)")
        ...
        V = (t) => {
          const e = (0, d.c)(),
            n = (0, d.c)(),
            r = (0, b.g)(t).querySelector(".toast-wrapper");
          return (
        ...
        $ = class {
          constructor(t) {
            (0, s.r)(this, t),
              (this.didPresent = (0, s.d)(this, "ionToastDidPresent", 7)),
              (this.willPresent = (0, s.d)(this, "ionToastWillPresent", 7)),
              (this.willDismiss = (0, s.d)(this, "ionToastWillDismiss", 7)),
              (this.didDismiss = (0, s.d)(this, "ionToastDidDismiss", 7)),
              (this.didPresentShorthand = (0, s.d)(this, "didPresent", 7)),
              (this.willPresentShorthand = (0, s.d)(this, "willPresent", 7)),
              (this.willDismissShorthand = (0, s.d)(this, "willDismiss", 7)),
              (this.didDismissShorthand = (0, s.d)(this, "didDismiss", 7)),
              (this.delegateController = (0, h.d)(this)),
              (this.lockController = (0, A.c)()),
              (this.triggerController = (0, h.e)()),
              (this.customHTMLEnabled = l.c.get(
              ...
              (this.dispatchCancelHandler = (e) => {
                if ((0, h.i)(e.detail.role)) {
                  const o = this.getButtons().find((r) => "cancel" === r.role);
              ...
              (this.createSwipeGesture = (e) => {
                (this.gesture = ((t, e, n) => {
                  ...
                  const a = "middle" === t.position ? 0.5 : 0,
                    g = "top" === t.position ? -1 : 1,
                    x = O(r, i.height),
                    j = [
                      {
                        offset: 0,
                        transform: `translateY(-${x + i.height}px)`,
                      },
                      { offset: 0.5, transform: "translateY(0px)" },
                      { offset: 1, transform: `translateY(${x + i.height}px)` },
                    ],
                    m = (0, d.c)("toast-swipe-to-dismiss-animation")
                      .addElement(o)
                      .duration(100);
                  switch (t.position) {
                    case "middle":
                  ...
                  const Y = (w) => (w * g) / u,
                    S = (0, D.createGesture)({
                      ...
                      direction: "y",
                      onMove: (w) => {
                        const M = a + Y(w.deltaY);
                        m.progressStep(M);
                      },
                      onEnd: (w) => {
                        const M = w.velocityY,
                          I = ((w.deltaY + 1e3 * M) / u) * g;
                        S.enable(!1);
                        let _ = !0,
                          B = 1,
                          E = 0,
                        ...
                        if ("middle" === t.position) {
                          (_ = I >= 0.25 || I <= -0.25), (B = 1), (E = 0);
                          const R = o.getBoundingClientRect(),
                            H = R.top - x,
                            W = (x + R.height) * (w.deltaY <= 0 ? -1 : 1);
                          m.keyframes([
                            { offset: 0, transform: `translateY(${H}px)` },
                            {
                              offset: 1,
                              transform: `translateY(${_ ? `${W}px` : "0px"})`,
                            },
                          ]),
                            (L = W - H);
                        } else
                          (_ = I >= 0.5),
                            ...
                            (E = Y(w.deltaY)),
                            (L = (_ ? 1 - E : E) * u);
                        const ot = Math.min(Math.abs(L) / Math.abs(M), 200);
                        m.onFinish(
                          () => {
                            _
                              ? (n(), m.destroy())
                              : ("middle" === t.position
                                  ? m.keyframes(j).progressStart(!0, 0.5)
                                  : m.progressStart(!0, 0),
                                S.enable(!0));
                          },
                          { oneTimeCallback: !0 },
              ...
              (this.duration = l.c.getNumber("toastDuration", 0)),
              (this.header = void 0),
                ...
                i = (function G(t, e, n, o) {
                  ...
                  if (
                    ...
                    return (
                      "top" === t
                        ? (r += i.bottom)
                        : "bottom" === t && (r -= k.w.innerHeight - i.top),
                      { top: `${r}px`, bottom: `${r}px` }
                    );
                  }
                  return {
                    top: `calc(${r}px + var(--ion-safe-area-top, 0px))`,
                    bottom: `calc(${r}px - var(--ion-safe-area-bottom, 0px))`,
                  };
                })(o, t.getAnchorElement(), (0, l.b)(t), n);
              (t.lastPresentedPosition = i),
                yield (0, h.f)(t, "toastEnter", K, N, {
                  position: o,
                  top: i.top,
                  bottom: i.bottom,
                }),
                ...
                t.prefersSwipeGesture() && t.createSwipeGesture(i),
                e();
            })();
          }
          dismiss(t, e) {
            ...
            return (0, y.c)(function* () {
              ...
              u && clearTimeout(u);
              const g = yield (0, h.g)(n, t, e, "toastLeave", F, V, {
                position: f,
                top: null !== (o = a?.top) && void 0 !== o ? o : "",
                bottom: null !== (r = a?.bottom) && void 0 !== r ? r : "",
              });
              return (
                g &&
          ...
          onDidDismiss() {
            return (0, h.h)(this.el, "ionToastDidDismiss");
          }
          onWillDismiss() {
            return (0, h.h)(this.el, "ionToastWillDismiss");
          }
          getButtons() {
            return this.buttons
              ? this.buttons.map((e) =>
          ...
          getAnchorElement() {
            ...
            if (void 0 !== e) {
              ...
              (0, v.p)("Invalid positionAnchor value:", e, n);
            }
          }
          buttonClick(t) {
            var e = this;
            return (0, y.c)(function* () {
              const n = t.role;
              return (0, h.i)(n) || (yield e.callButtonHandler(t))
                ? e.dismiss(void 0, n)
                : Promise.resolve();
            })();
          }
          callButtonHandler(t) {
            return (0, y.c)(function* () {
              if (t?.handler)
                try {
                  if (!1 === (yield (0, h.s)(t.handler))) return !1;
                } catch (e) {
                  console.error(e);
                }
              return !0;
                  ...
                  (0, s.h)(
                    ...
                    r.icon &&
                      (0, s.h)("ion-icon", {
                        "aria-hidden": "true",
                        icon: r.icon,
                        slot: void 0 === r.text ? "icon-only" : void 0,
                        class: "toast-button-icon",
                      }),
                    r.text,
                  ),
                  "md" === n &&
                    (0, s.h)("ion-ripple-effect", {
                      type:
                        void 0 !== r.icon && void 0 === r.text
                          ? "unbounded"
                          : "bounded",
                    }),
                ),
          ...
          render() {
            const {
              ...
              i = this.getButtons(),
              u = i.filter((x) => "start" === x.side),
              f = i.filter((x) => "start" !== x.side),
              a = (0, l.b)(this),
              g = {
                "toast-wrapper": !0,
            ...
            return (
              ...
              (0, s.h)(
                ...
                Object.assign(
                  ...
                  this.htmlAttributes,
                  {
                    ...
                    class: (0, p.c)(
                      this.color,
                      Object.assign(
                        Object.assign({ [a]: !0 }, (0, p.g)(this.cssClass)),
                        {
                          "overlay-hidden": !0,
                ...
                (0, s.h)(
                  "div",
                  { key: "27c0feeb89c4efb47c42623a4b036ed84338ed10", class: g },
                  (0, s.h)(
                    "div",
                    {
                    ...
                    (0, s.h)(
                      ...
                      n && void 0 !== r && this.renderToastMessage("header"),
                    ),
                    this.renderButtons(f, "end"),
                  ),
                ),
              )
            );
        ...
        q = (t) => ((0, h.i)(t.role) ? "button cancel" : "button");
      $.style = {
    ...
    5256: (z, C, c) => {
      c.d(C, { c: () => T, g: () => A, h: () => s, o: () => h });
      var y = c(1528);
      const s = (p, l) => null !== l.closest(p),
        T = (p, l) =>
          "string" == typeof p && p.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${p}`]: !0 }, l)
            : l,
        A = (p) => {
          const l = {};
          return (
        ...
        v = /^[a-z][a-z0-9+\-.]*:/,
        h = (function () {
          var p = (0, y.c)(function* (l, d, k, D) {
            if (null != l && "#" !== l[0] && !v.test(l)) {
              const P = document.querySelector("ion-router");
              if (P) return d?.preventDefault(), P.push(l, k, D);
            }
            return !1;
          });
          return function (d, k, D, P) {
