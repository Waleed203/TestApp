...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  ...
  {
    7752: (D, h, c) => {
      c.r(h), c.d(h, { ion_breadcrumb: () => i, ion_breadcrumbs: () => I });
      var o = c(2992),
        v = c(6384),
        l = c(5256),
        m = c(4812),
      ...
      const i = class {
        ...
        render() {
          const {
              ...
              routerDirection: j,
              separator: S,
              showCollapsedIndicator: B,
              target: P,
            } = this,
            A = this.isClickable(),
            E = void 0 === this.href ? "span" : "a",
            M = n ? void 0 : this.href,
            z = (0, u.b)(this),
            L = "span" === E ? {} : { download: s, href: M, target: P },
            R = !b && (a ? !(!B || b) : S);
          return (0, o.h)(
            o.H,
            {
              key: "632efa1bc6dc446e81efe8cd7763cb9b16466563",
              onClick: (w) => (0, l.o)(M, w, j, C),
              "aria-disabled": n ? "true" : null,
              class: (0, l.c)(p, {
                [z]: !0,
                "breadcrumb-active": d,
                "breadcrumb-collapsed": a,
                "breadcrumb-disabled": n,
                "in-breadcrumbs-color": (0, l.h)("ion-breadcrumbs[color]", x),
      ...
      const I = class {
        constructor(p) {
          (0, o.r)(this, p),
            (this.ionCollapsedClick = (0, o.d)(this, "ionCollapsedClick", 7)),
            (this.breadcrumbsInit = () => {
              this.setBreadcrumbSeparator(), this.setMaxItems();
            }),
            (this.resetActiveBreadcrumb = () => {
              const a = this.getBreadcrumbs().find((n) => n.active);
              a && this.activeChanged && (a.active = !1);
            }),
            (this.setMaxItems = () => {
              const {
                  itemsAfterCollapse: d,
                  itemsBeforeCollapse: a,
                  maxItems: n,
                } = this,
              ...
              void 0 !== n &&
                ...
                a + d <= n &&
                s.forEach((e, b) => {
                  b === a && (e.showCollapsedIndicator = !0),
                    b >= a && b < s.length - d && (e.collapsed = !0);
                });
            }),
            (this.setBreadcrumbSeparator = () => {
              ...
              for (const e of s) {
                const b =
                  void 0 !== n && 0 === d ? e === s[a] : e === s[s.length - 1];
                (e.last = b),
                  (e.separator =
                    void 0 !== e.separator ? e.separator : !b || void 0),
                  !x && b && ((e.active = !0), (this.activeChanged = !0));
              }
            }),
            (this.getBreadcrumbs = () =>
        ...
        onCollapsedClick(p) {
          const a = this.getBreadcrumbs().filter((n) => n.collapsed);
          this.ionCollapsedClick.emit(
            Object.assign(Object.assign({}, p.detail), {
              collapsedBreadcrumbs: a,
            }),
          );
        }
        maxItemsChanged() {
        ...
        render() {
          const { color: p, collapsed: d } = this,
            a = (0, u.b)(this);
          return (0, o.h)(
            o.H,
            {
    ...
    5256: (D, h, c) => {
      c.d(h, { c: () => l, g: () => u, h: () => v, o: () => y });
      var o = c(1528);
      const v = (t, r) => null !== r.closest(t),
        l = (t, r) =>
          "string" == typeof t && t.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${t}`]: !0 }, r)
            : r,
        u = (t) => {
          const r = {};
          return (
        ...
        _ = /^[a-z][a-z0-9+\-.]*:/,
        y = (function () {
          var t = (0, o.c)(function* (r, i, k, f) {
            if (null != r && "#" !== r[0] && !_.test(r)) {
              const g = document.querySelector("ion-router");
              if (g) return i?.preventDefault(), g.push(r, k, f);
            }
            return !1;
          });
          return function (i, k, f, g) {
