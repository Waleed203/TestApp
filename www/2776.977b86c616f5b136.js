  ...
  [2776],
  {
      ...
      const j = class {
          constructor(t) {
            ...
            (0, o.r)(this, t),
              ...
              (this.inputId = "ion-tg-" + B++),
              (this.lastDrag = 0),
              (this.inheritedAttributes = {}),
              (this.didLoad = !1),
              (this.hasLoggedDeprecationWarning = !1),
              (this.setupGesture = (0, m.c)(function* () {
                const { toggleTrack: e } = a;
                e &&
                  ((a.gesture = (yield Promise.resolve().then(
                    r.bind(r, 2528),
                  )).createGesture({
                    el: e,
                    gestureName: "toggle",
              ...
              (this.onClick = (e) => {
                this.disabled ||
                  (e.preventDefault(),
                  this.lastDrag + 300 < Date.now() && this.toggleChecked());
              }),
              (this.onFocus = () => {
                this.ionFocus.emit();
              }),
              ...
              (this.getSwitchLabelIcon = (e, n) =>
                "md" === e ? (n ? l.f : l.r) : n ? l.r : l.g),
              (this.activated = !1),
              (this.color = void 0),
              ...
              (this.disabled = !1),
              (this.value = "on"),
              (this.enableOnOffLabels = s.c.get("toggleOnOffLabels")),
          ...
          toggleChecked() {
            const { checked: t, value: a } = this,
              e = !t;
            (this.checked = e), this.ionChange.emit({ checked: e, value: a });
          }
          connectedCallback() {
            var t = this;
            return (0, m.c)(function* () {
              (t.legacyFormController = (0, u.c)(t.el)),
                t.didLoad && t.setupGesture();
            })();
          }
          componentDidLoad() {
            this.setupGesture(), (this.didLoad = !0);
          }
          ...
          onMove(t) {
            P((0, d.i)(this.el), this.checked, t.deltaX, -10) &&
              (this.toggleChecked(), (0, x.c)());
          }
          onEnd(t) {
            (this.activated = !1),
          ...
          renderOnOffSwitchLabels(t, a) {
            const e = this.getSwitchLabelIcon(t, a);
            return (0, o.h)("ion-icon", {
              class: {
                "toggle-switch-icon": !0,
                "toggle-switch-icon-checked": a,
              },
              icon: e,
              "aria-hidden": "true",
            });
          ...
          renderToggleControl() {
            const t = (0, s.b)(this),
              { enableOnOffLabels: a, checked: e } = this;
            return (0, o.h)(
              "div",
              {
                class: "toggle-icon",
                part: "track",
                ref: (n) => (this.toggleTrack = n),
              },
              a &&
                "ios" === t && [
                  this.renderOnOffSwitchLabels(t, !0),
                  this.renderOnOffSwitchLabels(t, !1),
                ],
              (0, o.h)(
                "div",
                ...
                (0, o.h)(
                  "div",
                  { class: "toggle-inner", part: "handle" },
                  a && "md" === t && this.renderOnOffSwitchLabels(t, e),
                ),
              ),
            );
          }
            ...
            return (
              ...
              (0, o.h)(
                o.H,
                {
                  ...
                  class: (0, i.c)(a, {
                    [C]: !0,
                    "in-item": (0, i.h)("ion-item", g),
                    "toggle-activated": t,
                    "toggle-checked": e,
                    "toggle-disabled": n,
                    [`toggle-justify-${h}`]: !0,
                    [`toggle-alignment-${E}`]: !0,
                    [`toggle-label-placement-${v}`]: !0,
                    [`toggle-${D}`]: !0,
                  }),
                },
                (0, o.h)(
          ...
          renderLegacyToggle() {
            ...
            const {
              ...
              y = (0, s.b)(this),
              { label: _, labelId: E, labelText: C } = (0, c.e)(g, h),
              O = this.getValue(),
              D = (0, d.i)(g) ? "rtl" : "ltr";
            return (
              (0, c.d)(!0, g, v, e ? O : "", n),
    ...
    5256: (M, p, r) => {
      ...
      const o = (i, l) => null !== l.closest(i),
        ...
        x = /^[a-z][a-z0-9+\-.]*:/,
        d = (function () {
          var i = (0, m.c)(function* (l, s, w, k) {
            if (null != l && "#" !== l[0] && !x.test(l)) {
              const f = document.querySelector("ion-router");
              if (f) return s?.preventDefault(), f.push(l, w, k);
            }
            return !1;
          });
          return function (s, w, k, f) {
