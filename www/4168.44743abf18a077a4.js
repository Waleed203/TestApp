  ...
  [4168],
  {
    4168: (re, N, f) => {
      ...
      const G = (t, e, o) => {
            ...
            var o = (0, S.c)(function* (r) {
              ...
              if ("ION-POPOVER" === a || "ION-ITEM" === a) {
                ...
                switch (r.key) {
                  ...
                  case "ArrowDown":
                    r.preventDefault();
                    const l = ((t, e) => t[H(t, e) + 1])(s, n);
                    void 0 !== l && z(l);
                    break;
                  case "ArrowUp":
                    r.preventDefault();
                    const y = ((t, e) => t[H(t, e) - 1])(s, n);
                    void 0 !== y && z(y);
                    break;
                  case "Home":
                    r.preventDefault();
                  ...
                  case "Enter":
                    if (
                      ...
                      const m = new CustomEvent("ionPopoverActivateTrigger");
                      n.dispatchEvent(m);
                    }
                }
              }
        ...
        J = (t, e, o, r, i, n, s, a, p, l, y) => {
          var u;
          let b = { top: 0, left: 0, width: 0, height: 0 };
          if ("event" === n) {
            if (!y) return p;
            b = { top: y.clientY, left: y.clientX, width: 1, height: 1 };
          } else {
            const c = y,
              L =
                l ||
                (null === (u = c?.detail) || void 0 === u
                  ? void 0
                  : u.ionShadowTarget) ||
                c?.target;
            if (!L) return p;
            const A = L.getBoundingClientRect();
            b = { top: A.top, left: A.left, width: A.width, height: A.height };
          }
          const m = he(s, b, e, o, r, i, t),
            k = ue(a, s, b, e, o),
            _ = m.top + k.top,
            E = m.left + k.left,
            { arrowTop: x, arrowLeft: I } = fe(s, r, i, _, E, e, o, t),
            { originX: D, originY: O } = le(s, a, t);
          return {
            top: _,
            left: E,
            referenceCoordinates: b,
            arrowTop: x,
            arrowLeft: I,
            originX: D,
            originY: O,
        ...
        le = (t, e, o) => {
          switch (t) {
            case "top":
              return { originX: Q(e), originY: "bottom" };
            case "bottom":
              return { originX: Q(e), originY: "top" };
            case "left":
              return { originX: "right", originY: U(e) };
            case "right":
              return { originX: "left", originY: U(e) };
            case "start":
              return { originX: o ? "left" : "right", originY: U(e) };
            case "end":
              return { originX: o ? "right" : "left", originY: U(e) };
          }
        },
        Q = (t) => {
          switch (t) {
        ...
        fe = (t, e, o, r, i, n, s, a) => {
          const p = { arrowTop: r + s / 2 - e / 2, arrowLeft: i + n - e / 2 },
            l = { arrowTop: r + s / 2 - e / 2, arrowLeft: i - 1.5 * e };
          switch (t) {
            case "top":
        ...
        he = (t, e, o, r, i, n, s) => {
          const a = { top: e.top, left: e.left - o - i },
            p = { top: e.top, left: e.left + e.width + i };
          switch (t) {
            case "top":
        ...
        Z = (t, e, o, r, i, n, s, a, p, l, y, u, b = 0, m = 0, k = 0) => {
          let _ = b;
          const E = m;
          let D,
            x = o,
            ...
            c = !1,
            L = !1;
          const A = u ? u.top + u.height : n / 2 - a / 2,
            M = u ? u.height : 0;
          let R = !1;
          return (
            x < r + p
              ? ((x = r), (c = !0), (O = "left"))
              : s + r + x + p > i && ((L = !0), (x = i - s - r), (O = "right")),
            A + M + a > n &&
              ("top" === t || "bottom" === t) &&
              (A - a > 0
                ? ((I = Math.max(12, A - a - M - (k - 1))),
                  (_ = I + a),
                  (C = "bottom"),
                  (R = !0))
                : (D = r)),
        ...
        xe = (t, e) => {
          ...
          const {
            ...
            l = t.ownerDocument,
            y = "rtl" === l.dir,
            u = l.defaultView.innerWidth,
            b = l.defaultView.innerHeight,
            m = (0, P.g)(t),
            k = m.querySelector(".popover-content"),
            _ = m.querySelector(".popover-arrow"),
            E =
              n ||
              (null === (o = r?.detail) || void 0 === o
                ? void 0
                : o.ionShadowTarget) ||
              r?.target,
            { contentWidth: x, contentHeight: I } = G(i, k, E),
            { arrowWidth: D, arrowHeight: O } = ((t) => {
            ...
            A = "cover" === i ? 0 : 25,
            {
              ...
              bottom: K,
              checkSafeAreaLeft: X,
              checkSafeAreaRight: Ee,
              arrowTop: Ie,
              arrowLeft: Te,
              addPopoverBottomClass: Oe,
            } = Z(
              a,
              c.top,
              c.left,
          ...
          return (
            te
              .addElement(m.querySelector("ion-backdrop"))
              .fromTo("opacity", 0.01, "var(--backdrop-opacity)")
              .beforeStyles({ "pointer-events": "none" })
              .afterClearStyles(["pointer-events"]),
            oe
              .addElement(m.querySelector(".popover-arrow"))
              .addElement(m.querySelector(".popover-content"))
              .fromTo("opacity", 0.01, 1),
            Ce.easing("ease")
              .duration(100)
              .beforeAddWrite(() => {
                "cover" === i && t.style.setProperty("--width", `${x}px`),
                  Oe && t.classList.add("popover-bottom"),
                  void 0 !== K && k.style.setProperty("bottom", `${K}px`);
                let q = `${W}px`;
                X && (q = `${W}px + var(--ion-safe-area-left, 0)`),
                  Ee && (q = `${W}px - var(--ion-safe-area-right, 0)`),
                  k.style.setProperty(
                    "top",
                    `calc(${j}px + var(--offset-y, 0))`,
                  ),
                  k.style.setProperty(
                    "left",
                    `calc(${q} + var(--offset-x, 0))`,
                  ),
                  k.style.setProperty("transform-origin", `${R} ${M}`),
                  null !== _ &&
                    (((t, e = !1, o, r) =>
                      ...
                      ? (_.style.setProperty(
                          "top",
                          `calc(${Ie}px + var(--offset-y, 0))`,
                        ),
                        _.style.setProperty(
                          "left",
                          `calc(${Te}px + var(--offset-x, 0))`,
                        ))
        ...
        ke = (t, e) => {
          ...
          const {
            ...
            _ =
              ...
              (null === (o = r?.detail) || void 0 === o
                ...
                : o.ionShadowTarget) ||
              r?.target,
            { contentWidth: E, contentHeight: x } = G(i, k, _),
            D = J(
              y,
              E,
              x,
          ...
          return (
            j
              ...
              .beforeStyles({ "pointer-events": "none" })
              .afterClearStyles(["pointer-events"]),
            W.addElement(m.querySelector(".popover-wrapper"))
              .duration(150)
              .fromTo("opacity", 0.01, 1),
            K.addElement(k)
              .beforeStyles({
                top: `calc(${L}px + var(--offset-y, 0px))`,
                left: `calc(${A}px + var(--offset-x, 0px))`,
                "transform-origin": `${c} ${C}`,
              })
              .beforeAddWrite(() => {
                void 0 !== M && k.style.setProperty("bottom", `${M}px`);
              })
              .fromTo("transform", "scale(0.8)", "scale(1)"),
            X.addElement(m.querySelector(".popover-viewport")).fromTo(
              "opacity",
              0.01,
              1,
            ),
            R.easing("cubic-bezier(0.36,0.66,0.04,1)")
              .duration(300)
              .beforeAddWrite(() => {
                "cover" === i && t.style.setProperty("--width", `${E}px`),
                  "bottom" === c && t.classList.add("popover-bottom");
              })
              .addAnimation([j, W, K, X])
          );
        },
        Pe = (t) => {
          const e = (0, P.g)(t),
        ...
        ee = class {
          constructor(t) {
            (0, d.r)(this, t),
              (this.didPresent = (0, d.d)(this, "ionPopoverDidPresent", 7)),
              (this.willPresent = (0, d.d)(this, "ionPopoverWillPresent", 7)),
              (this.willDismiss = (0, d.d)(this, "ionPopoverWillDismiss", 7)),
              (this.didDismiss = (0, d.d)(this, "ionPopoverDidDismiss", 7)),
              (this.didPresentShorthand = (0, d.d)(this, "didPresent", 7)),
              (this.willPresentShorthand = (0, d.d)(this, "willPresent", 7)),
              (this.willDismissShorthand = (0, d.d)(this, "willDismiss", 7)),
              (this.didDismissShorthand = (0, d.d)(this, "didDismiss", 7)),
              (this.ionMount = (0, d.d)(this, "ionMount", 7)),
              (this.parentPopover = null),
              (this.coreDelegate = (0, $.C)()),
              (this.lockController = (0, B.c)()),
              (this.inline = !1),
              (this.focusDescendantOnPresent = !1),
              (this.onBackdropTap = () => {
                this.dismiss(void 0, T.B);
              }),
              (this.onLifecycle = (e) => {
              ...
              (this.configureTriggerInteraction = () => {
                ...
                n
                  ? (this.destroyTriggerInteraction = se(n, o, r))
                  : (0, V.p)(
              ...
              (this.configureKeyboardInteraction = () => {
                ...
                e && e(), (this.destroyKeyboardInteraction = de(o));
              }),
                ...
                !o ||
                  ...
                  (this.destroyDismissInteraction = ((t, e, o, r) => {
                    ...
                    return (
                      ...
                      i.forEach(({ eventName: a, callback: p }) =>
                        s.addEventListener(a, p),
                      ),
                      () => {
                        i.forEach(({ eventName: a, callback: p }) =>
                          s.removeEventListener(a, p),
                        );
                      }
                    );
                  })(i, r, n, o)));
          ...
          present(t) {
            ...
            return (0, S.c)(function* () {
              ...
              e.ionMount.emit(),
                ...
                (0, P.m)(r)
                  ? yield (0, w.e)(e.usersElement)
                  : e.keepContentsMounted || (yield (0, w.w)()),
                yield (0, T.f)(e, "popoverEnter", xe, ke, {
                  event: t || e.event,
                  size: e.size,
                  trigger: e.triggerEl,
                ...
                e.focusDescendantOnPresent && (0, T.n)(e.el, e.el),
                o();
            })();
          }
          dismiss(t, e, o = !0) {
            ...
            return (0, S.c)(function* () {
              ...
              if (a) {
                ...
                const { delegate: p } = r.getDelegate();
                yield (0, $.d)(p, r.usersElement);
              }
              return i(), a;
            })();
          }
          ...
          onDidDismiss() {
            return (0, T.h)(this.el, "ionPopoverDidDismiss");
          }
          onWillDismiss() {
            return (0, T.h)(this.el, "ionPopoverWillDismiss");
          }
          render() {
            const t = (0, h.b)(this),
              {
            ...
            return (0, d.h)(
              ...
              Object.assign(
                ...
                s,
                {
                  ...
                  class: Object.assign(
                    Object.assign({}, (0, g.g)(this.cssClass)),
                    {
                      [t]: !0,
              ...
              (0, d.h)(
                ...
                p && (0, d.h)("div", { class: "popover-arrow", part: "arrow" }),
                (0, d.h)(
                  "div",
                  {
    ...
    5256: (re, N, f) => {
      f.d(N, { c: () => $, g: () => B, h: () => d, o: () => T });
      var S = f(1528);
      const d = (h, g) => null !== g.closest(h),
        $ = (h, g) =>
          "string" == typeof h && h.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${h}`]: !0 }, g)
            : g,
        B = (h) => {
          const g = {};
          return (
        ...
        V = /^[a-z][a-z0-9+\-.]*:/,
        T = (function () {
          var h = (0, S.c)(function* (g, w, v, F) {
            if (null != g && "#" !== g[0] && !V.test(g)) {
              const Y = document.querySelector("ion-router");
              if (Y) return w?.preventDefault(), Y.push(g, v, F);
            }
            return !1;
          });
          return function (w, v, F, Y) {
