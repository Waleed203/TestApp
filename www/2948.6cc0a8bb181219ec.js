...
(self.webpackChunkapp = self.webpackChunkapp || []).push([
  [2948],
  {
    2948: (k, h, s) => {
      ...
      const g = (i) => {
          ...
          return (
            ...
            r.addElement(i.querySelector(".loading-wrapper")).keyframes([
        ...
        x = class {
          constructor(i) {
            (0, t.r)(this, i),
              ...
              (this.delegateController = (0, l.d)(this)),
              (this.lockController = (0, b.c)()),
              (this.triggerController = (0, l.e)()),
              (this.customHTMLEnabled = a.c.get(
                "innerHTMLTemplatesEnabled",
                m.E,
              )),
              (this.presented = !1),
              (this.onBackdropTap = () => {
                this.dismiss(void 0, l.B);
              }),
          ...
          onIsOpenChange(i, o) {
            !0 === i && !1 === o
              ? this.present()
              : !1 === i && !0 === o && this.dismiss();
          }
          triggerChanged() {
            const { trigger: i, el: o, triggerController: e } = this;
            i && e.addClickListener(o, i);
          }
          connectedCallback() {
            (0, l.j)(this.el), this.triggerChanged();
          }
          componentWillLoad() {
            if (void 0 === this.spinner) {
              const i = (0, a.b)(this);
              this.spinner = a.c.get(
                "loadingSpinner",
                a.c.get("spinner", "ios" === i ? "lines" : "crescent"),
              );
            }
            (0, l.k)(this.el);
          }
          ...
          present() {
            ...
            return (0, p.c)(function* () {
              const o = yield i.lockController.lock();
              yield i.delegateController.attachViewToDom(),
                yield (0, l.f)(i, "loadingEnter", g, w),
                i.duration > 0 &&
          ...
          dismiss(i, o) {
            var e = this;
            return (0, p.c)(function* () {
              const r = yield e.lockController.lock();
              e.durationTimeout && clearTimeout(e.durationTimeout);
              const f = yield (0, l.g)(e, i, o, "loadingLeave", c, E);
              return f && e.delegateController.removeViewFromDom(), r(), f;
            })();
          }
          onDidDismiss() {
            return (0, l.h)(this.el, "ionLoadingDidDismiss");
          }
          onWillDismiss() {
            return (0, l.h)(this.el, "ionLoadingWillDismiss");
          }
          renderLoadingMessage(i) {
            const { customHTMLEnabled: o, message: e } = this;
            return o
              ? (0, t.h)("div", {
              ...
              Object.assign(
                {
                  ...
                  role: "dialog",
                  "aria-modal": "true",
                  "aria-labelledby": void 0 !== i ? v : null,
                  tabindex: "-1",
                },
                e,
                {
                  ...
                  class: Object.assign(
                    Object.assign({}, (0, y.g)(this.cssClass)),
                    {
                      [f]: !0,
                      "overlay-hidden": !0,
              ...
              (0, t.h)(
                ...
                o &&
                  (0, t.h)(
                    ...
                    (0, t.h)("ion-spinner", { name: o, "aria-hidden": "true" }),
                  ),
                void 0 !== i && this.renderLoadingMessage(v),
              ),
              (0, t.h)("div", {
    ...
    5256: (k, h, s) => {
      s.d(h, { c: () => m, g: () => b, h: () => t, o: () => y });
      var p = s(1528);
      const t = (a, n) => null !== n.closest(a),
        m = (a, n) =>
          "string" == typeof a && a.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${a}`]: !0 }, n)
            : n,
        b = (a) => {
          const n = {};
          return (
        ...
        l = /^[a-z][a-z0-9+\-.]*:/,
        y = (function () {
          var a = (0, p.c)(function* (n, d, _, g) {
            if (null != n && "#" !== n[0] && !l.test(n)) {
              const c = document.querySelector("ion-router");
              if (c) return d?.preventDefault(), c.push(n, _, g);
            }
            return !1;
          });
          return function (d, _, g, c) {
