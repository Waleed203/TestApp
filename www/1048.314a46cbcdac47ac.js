  ...
  [1048],
  {
    1048: (w, c, e) => {
      ...
      const r = class {
        ...
        componentWillLoad() {
          this.inheritedAriaAttributes = (0, p.k)(this.el, ["aria-label"]);
        }
        isClickable() {
          return void 0 !== this.href || this.button;
        }
        renderCard(o) {
          const b = this.isClickable();
          if (!b) return [(0, t.h)("slot", null)];
          const {
              href: y,
              routerAnimation: A,
              routerDirection: T,
              inheritedAriaAttributes: D,
            } = this,
            C = b ? (void 0 === y ? "button" : "a") : "div";
          return (0, t.h)(
            C,
            Object.assign(
              {},
              ...
              D,
              {
                ...
                onClick: (O) => (0, a.o)(y, O, T, A),
              },
            ),
            (0, t.h)("slot", null),
            b && "md" === o && (0, t.h)("ion-ripple-effect", null),
          );
        }
        render() {
          const o = (0, s.b)(this);
        ...
        render() {
          ...
          return (0, t.h)(
            t.H,
            {
              ...
              role: "heading",
              "aria-level": "3",
              class: (0, a.c)(this.color, { "ion-inherit-color": !0, [o]: !0 }),
            },
            (0, t.h)("slot", {
    ...
    5256: (w, c, e) => {
      e.d(c, { c: () => a, g: () => m, h: () => p, o: () => f });
      var t = e(1528);
      const p = (n, r) => null !== r.closest(n),
        a = (n, r) =>
          "string" == typeof n && n.length > 0
            ? Object.assign({ "ion-color": !0, [`ion-color-${n}`]: !0 }, r)
            : r,
        m = (n) => {
          const r = {};
          return (
        ...
        h = /^[a-z][a-z0-9+\-.]*:/,
        f = (function () {
          var n = (0, t.c)(function* (r, i, l, g) {
            if (null != r && "#" !== r[0] && !h.test(r)) {
              const d = document.querySelector("ion-router");
              if (d) return i?.preventDefault(), d.push(r, l, g);
            }
            return !1;
          });
          return function (i, l, g, d) {
